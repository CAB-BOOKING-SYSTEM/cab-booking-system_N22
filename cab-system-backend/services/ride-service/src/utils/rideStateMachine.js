...
const TRANSITIONS = {
  [RIDE_STATES.CREATED]: [RIDE_STATES.MATCHING],
  [RIDE_STATES.MATCHING]: [RIDE_STATES.ASSIGNED],
  [RIDE_STATES.ASSIGNED]: [RIDE_STATES.PICKUP],
  [RIDE_STATES.PICKUP]: [RIDE_STATES.IN_PROGRESS],
  [RIDE_STATES.IN_PROGRESS]: [RIDE_STATES.COMPLETED],
